...
export function Sidebar() {
  ...
  useEffect(() => {
    ...
    const activeTitle = NAV_GROUPS.find(
      (group) =>
        group.title && group.items.some((item) => item.to === pathname),
    )?.title;

    setOpenGroups(activeTitle ? { [activeTitle]: true } : {});
  }, [pathname]);
